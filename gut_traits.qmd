...
| GD   | Gut diameter     | External diameter of the intestine (average of 10 measurements)                                                                                 | @Ghilardi2021 |
| GS   | Gut surface area | External surface area of the intestine calculated as GL x 2$\pi$(GD/2)                                                                          | @Ghilardi2021 |

: Morphometric parameters measured on fish intestine {#tbl-gut-def}
...
2. Trace a segmented line following the midline of the intestine as shown below. After clicking `OK` 10 points appears equally distributed along this line.
