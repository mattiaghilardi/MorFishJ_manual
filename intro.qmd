...
Now `MorFishJ` is installed. Open ImageJ/FIJI and click **Plugins --\> MorFishJ v{{< var version >}} --\> MorFishJ GUI**. The following GUI appears in the upper left corner of the screen.
