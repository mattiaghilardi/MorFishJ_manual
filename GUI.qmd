...
![](images/screenshots/MorFishJ_GUI_v0.0.1.png){width="70%" fig-align="center" fig-alt="MorFishJ GUI"}
...
Each analysis have three different buttons:
...
![](images/screenshots/single_image_error.png){width="40%" fig-align="center" fig-alt="Error message for single image analysis"}
...
![](images/screenshots/dialog_select_directories.png){width="80%" fig-align="center" fig-alt="Dialog for directories selection"}
...
-   a log file with the name `TraitLog` followed by the date of creation and including all the metadata required to restore the project.
