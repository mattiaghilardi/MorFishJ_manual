...
The `Head Angles` analysis allows to extract three angles ([@tbl-angles-def]) related to vision and feeding [@Brandl2013; @Bellwood2014; @Brandl2015]. 
...
: Head angles measured on fish images {#tbl-angles-def}
:::
...
: Reference lines and points traced on fish images to aid the measurement of head angles {#tbl-angles-ref-lines}
:::
