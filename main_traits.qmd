...
![Reference lines traced on fish images for main traits analysis (see @tbl-main-ref-lines for descriptions)](images/drawings/main_ref_lines_sketch.png){width="80%" fig-align="center" fig-alt="Reference lines for main traits analysis" #fig-main-ref-lines}
...
![Linear measurements](images/drawings/main_traits_sketch.png){fig-alt="Linear measurements" #fig-main-linear}

![Surface areas](images/drawings/main_areas_sketch.png){fig-alt="Surface areas" #fig-main-areas}
