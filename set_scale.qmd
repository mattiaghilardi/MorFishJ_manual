...
::: {.callout-warning}
At the moment it is not possible to run the `Main Traits` and ` Gut Traits` analyses on images without a reference object or known fish length as setting the scale is required.
:::
