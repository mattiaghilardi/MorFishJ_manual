...
![](images/screenshots/adjust_image.png){width="40%" fig-align="center" fig-alt="Dialog for image adjustment"}
...
Therefore, if the fish is not straight and horizontal, select the appropriate option and click `OK`. Otherwise, select `No adjustments` and click `OK` to continue.
